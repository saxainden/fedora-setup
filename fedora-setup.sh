...
wget https://raw.githubusercontent.com/saxainden/fedora-setup/master/fedora.packages
wget https://raw.githubusercontent.com/saxainden/fedora-setup/master/bashrc.aliases
